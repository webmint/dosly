...
4. If you're unsure whether an icon exists, check [`icons.md`](icons.md) for the canonical list, or let the Dart analyzer confirm the field resolves.
...
- [`theme.md`](theme.md) — the theme system (color roles, text styles, runtime mode)
