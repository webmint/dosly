...
/// Builds a widget tree wrapping [HistoryScreen] under the requested [locale].
///
...
void main() {
  group('HistoryScreen locale switching', () {
    testWidgets('renders "History" under Locale("en")', (tester) async {
    ...
    testWidgets('renders "Verlauf" under Locale("de")', (tester) async {
    ...
    testWidgets('renders "Історія" under Locale("uk")', (tester) async {
  ...
  group('HistoryScreen AppBar shape', () {
